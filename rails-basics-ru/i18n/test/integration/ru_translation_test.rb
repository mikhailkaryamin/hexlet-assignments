...
class RuTranslationTest < ActionDispatch::IntegrationTest
  ...
  test 'home#index' do
    ...
    assert_select 'ul.nav', text: /Домашняя страница/
  ...
  test 'posts#index' do
    ...
    assert_select '#new-post-link', text: 'Добавить пост'
  end
  ...
  test 'posts#new' do
    ...
    assert_select '.new_post #post_title[placeholder=?]', 'Заголовок'
  end
  ...
  test 'posts#create check validation' do
    ...
    assert_select '.new_post .post_title .invalid-feedback', 'Заголовок не может быть пустым'
  end
  ...
  test 'posts#create successfully' do
    ...
    assert_select '.alert-info', 'Пост был создан.'
  end
  ...
  test 'posts#update' do
    ...
    assert_select '.alert-info', 'Пост был обновлен.'
  end
  ...
  test 'posts#destroy' do
    ...
    assert_select '.alert-info', 'Пост был удален.'
  end
